...
export const useTabs = () => {
    ...
    const [tabsDesktop, setTabsDesktop, refreshTabsFromBackend1] = useBackendState<iTab[]>('tabs',[], {history: false})
    const [tabsMobile, setTabsMobile, refreshTabsFromBackend2] = useBackendState<iTab[]>('tabs-mobile',[], {history: false})
    const tabsRef = useRef<iTab[]>([])
    const setTabs = (nTabs:iTab[], cb?:Function) => {
		tabsRef.current = nTabs
		setTabsInt(tabsRef.current)
