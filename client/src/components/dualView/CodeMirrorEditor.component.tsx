...
import { useElResize, useResize } from "../../hooks/useResize.hook";
...
// import {parser} from "./parser.js"
		...
		const activateTitleInt = () => {
				...
				const els2 = document.querySelectorAll(".tiro-image")
				each(els, el => {
		...
		return (
				...
				styles: [
						...
						// { tag: realCustomTags.ImageTwo, color: "blue", class: "workiiiiing" },
